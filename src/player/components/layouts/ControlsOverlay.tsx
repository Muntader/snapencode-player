...
import { useFullscreenState } from "@/player/hooks/useFullscreen";
import { usePlayerActivity } from "@/player/hooks/usePlayerActivity";
import { useInteraction } from "@/player/hooks/useInteraction";
import { CastingOverlay } from "@/player/components/layouts/CastingOverlay";
import Header from "@/player/components/layouts/Header";
import Loader from "@/player/components/common/Loader";
import BackwardButton from "@/player/components/controls/BackwardButton";
import { BigButton } from "@/player/components/controls/BigButton";
import ForwardButton from "@/player/components/controls/ForwardButton";
import { ControlBottom } from "@/player/components/controls";
import { cn } from "@/player/utils/cn";
// ModalContainer import is not needed here, but the hook is.
import { useModal } from "@/player/store/useModalStore"; // <<< 1. IMPORT THE HOOK
