...
import {useHasNext, useHasPlaylist, usePlayerConfigStore} from "@/player/store/usePlayerConfigStore";
import ProgressBar from "@/player/components/timeline/ProgressBar";
import NextButton from "@/player/components/controls/NextButton";
import {SettingsButton} from "@/player/components/settings/SettingButton";
import {PlaylistButton} from "@/player/components/playlist/PlaylistButton";
