...
import {PlaylistMenu} from "@/player/components/playlist/PlaylistMenu";
...
export const PlaylistButton: React.FC<SettingsButtonProps> = ({
                                                                  className,
    ...
    const handleClick = useCallback(() => {
        ...
        if (useModal.getState().isOpen) {
            ...
            // @ts-ignore
            openModal(<PlaylistMenu />, buttonRef, { width: 600 });
        }
